# Generated by Django 4.2.8 on 2024-01-02 04:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_scop', models.CharField(max_length=255)),
                ...
                ('user_permissions', models.ManyToManyField(blank=True, error_messages={'add': 'The permission could not be created.', 'remove': 'The permission could not be removed.'}, help_text='Specific permissions for this user.', related_name='customuser_user_permissions', to='auth.permission', verbose_name='user permissions')),
            ],
            options={
                'verbose_name': 'user',
